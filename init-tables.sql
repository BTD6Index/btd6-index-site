...
CREATE TRIGGER '2tc_completions_ai' AFTER INSERT ON '2tc_completions' BEGIN
    INSERT INTO '2tc_completions_fts' (rowid, tower1, tower2, map, person, link, og, pending)
    VALUES (new.rowid, new.tower1, new.tower2, new.map, new.person, new.link, new.og, new.pending);
END;
CREATE TRIGGER '2tc_completions_ad' AFTER DELETE ON '2tc_completions' BEGIN
    INSERT INTO '2tc_completions_fts' ('2tc_completions_fts', rowid, tower1, tower2, map, person, link, og, pending)
    VALUES ('delete', old.rowid, old.tower1, old.tower2, old.map, old.person, old.link, old.og, old.pending);
END;
...
CREATE TRIGGER '2mp_completions_ai' AFTER INSERT ON '2mp_completions' BEGIN
    INSERT INTO '2mp_completions_fts' (rowid, entity, map, person, link, og, pending)
    VALUES (new.rowid, new.entity, new.map, new.person, new.link, new.og, new.pending);
END;
CREATE TRIGGER '2mp_completions_ad' AFTER DELETE ON '2mp_completions' BEGIN
    INSERT INTO '2mp_completions_fts' ('2mp_completions_fts', rowid, entity, map, person, link, og, pending)
    VALUES ('delete', old.rowid, old.entity, old.map, old.person, old.link, old.og, old.pending);
END;
