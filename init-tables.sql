CREATE VIRTUAL TABLE '2tc_completions' USING fts5(
    tower1, tower2, map, person, link, og, pending UNINDEXED, tokenize="unicode61 remove_diacritics 2"
);
CREATE VIRTUAL TABLE '2mp_completions' USING fts5(
    entity, map, person, link, og, pending UNINDEXED, tokenize="unicode61 remove_diacritics 2"
);
