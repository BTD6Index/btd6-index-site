...
export async function onRequest(context) {
    ...
    (SELECT difficulty FROM twomp_completions INNER JOIN map_information ON twomp_completions.map = map_information.map WHERE person = person0 GROUP BY difficulty ORDER BY count(*) DESC LIMIT 1) AS favoritedifficulty
